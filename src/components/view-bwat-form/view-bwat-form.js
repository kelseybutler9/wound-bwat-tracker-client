...
export class ViewBWATForm extends React.Component {
  ...
  constructor (props) {
    super(props);
    this.state = {
      questionChoices: {        question_one: [`1 = Length x width less than 4 sq cm`,`2 = Length x width 4-16 sq cm`, `3 = Length x width 16.1--36 sq cml`,`4 = Length x width 36.1--80 sq cm`,`5 = Length x width greater than 80 sq cm`],
